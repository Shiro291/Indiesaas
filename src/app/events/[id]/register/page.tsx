...
export default function EventRegistrationPage({
    ...
    const handleRegister = async () => {
        ...
        for (let i = 0; i < attendeeData.length; i++) {
            if (
                !attendeeData[i].gender ||
                !attendeeData[i].ageCategory ||
                !attendeeData[i].beltLevel ||
                !attendeeData[i].phoneNumber
            ) {
                alert(
                    `Please fill in all required fields for attendee ${i + 1}`
                )
                return
            }
        }
        ...
        <div className="container py-8">
            <div className="mx-auto max-w-4xl">
                ...
                <div className="mb-8 flex items-center justify-between">
                    ...
                    >
                        <div
                            className={`flex h-8 w-8 items-center justify-center rounded-full ${step === 1 ? "bg-primary text-primary-foreground" : "border-2 border-muted-foreground"}`}
                        >
                            1
                        </div>
                        <span className="mt-2 text-sm">Select Tickets</span>
                    </div>
                    <div className="mx-4 h-px flex-1 bg-muted-foreground/20" />
                    <div
                        className={`flex flex-col items-center ${step === 2 ? "text-primary" : "text-muted-foreground"}`}
                    >
                        <div
                            className={`flex h-8 w-8 items-center justify-center rounded-full ${step === 2 ? "bg-primary text-primary-foreground" : "border-2 border-muted-foreground"}`}
                        >
                            2
                        </div>
                    ...
                    >
                        <div
                            className={`flex h-8 w-8 items-center justify-center rounded-full ${step === 3 ? "bg-primary text-primary-foreground" : "border-2 border-muted-foreground"}`}
                        >
                            3
                        </div>
                ...
                <Card className="mb-6">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Complete the following steps to register for the
                            event
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        ...
                        {step === 2 && (
                            <div>
                                ...
                                <p className="mb-4 text-muted-foreground text-sm">
                                    ...
                                    (you selected {totalAttendees} ticket
                                    {totalAttendees !== 1 ? "s" : ""}).
                                </p>
                                            ...
                                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                                <div className="space-y-2">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            <RadioGroupItem
                                                                value="female"
                                                                id={`gender-${index}-female`}
                                                            />
                                                            <Label
                                                                htmlFor={`gender-${index}-female`}
                                                            >
                                                                Female
                                                            </Label>
                                                        </div>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    >
                                                        ...
                                                        <SelectContent>
                                                            <SelectItem value="DASAR">
                                                                DASAR
                                                            </SelectItem>
                                                            <SelectItem value="MC_I">
                                                                MC I
                                                            </SelectItem>
                                                            <SelectItem value="MC_II">
                                                                MC II
                                                            </SelectItem>
                                                            <SelectItem value="MC_III">
                                                                MC III
                                                            </SelectItem>
                                                            <SelectItem value="MC_IV">
                                                                MC IV
                                                            </SelectItem>
                                                        </SelectContent>
                                                    </Select>
