  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold">Analytics</h1>
          <p className="text-muted-foreground">View detailed statistics about your events</p>
        </div>
        <Button>
          Export Report
        </Button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <XAxis dataKey="month" />
                  <YAxis />
                  <Tooltip formatter={(value) => [`Rp. ${(Number(value) / 100).toLocaleString('id-ID')}`, 'Revenue']} />
                  <Legend />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Breakdown of registrations by event category</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    ...
                    dataKey="value"
                  >
                    {analytics.registrationsByCategory.map((entry, index) => (
                      <Cell key={`cell-${index}`} fill={COLORS[index % COLORS.length]} />
                    ))}
                  </Pie>
                  <Tooltip formatter={(value) => [`${value} registrations`, 'Registrations']} />
                </PieChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
            ...
            {[1, 2, 3, 4, 5].map((item) => (
              <div key={item} className="flex items-center justify-between p-3 hover:bg-muted rounded-md">
                ...
                <div className="text-right">
                  <p className="font-medium">24 registrations</p>
