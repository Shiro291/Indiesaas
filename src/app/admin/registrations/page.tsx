...
export default function AdminRegistrationsPage() {
  ...
  const filteredRegistrations = registrations.filter(reg => {
    ...
    const matchesAgeCategory = 
      filterAgeCategory === "" || 
      reg.attendees.some(attendee => attendee.ageCategory === filterAgeCategory);
    
    const matchesBeltLevel = 
      filterBeltLevel === "" || 
      reg.attendees.some(attendee => attendee.beltLevel === filterBeltLevel);
  ...
  return (
    <div className="p-6">
      ...
      <Card>
        <CardHeader className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div>
          ...
          <div>
            <Select value={filterAgeCategory} onValueChange={setFilterAgeCategory}>
              <SelectTrigger>
          ...
          <TableBody>
            {filteredRegistrations.map(registration => (
              <TableRow key={registration.id}>
                ...
                <TableCell>Rp. {(registration.totalAmount / 100).toLocaleString('id-ID')}</TableCell>
                <TableCell>
